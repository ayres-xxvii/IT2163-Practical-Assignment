<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndPassReset.aspx.cs" Inherits="IT2163_PractAssignment.EndPassReset" %>
...
.card {
    ...
    <script>
        function validate() {
            ...
            var str = document.getElementById('passwordTB').value.trim();
  ...
  <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
    <div class="d-table-cell align-middle">
      ...
      <div class="card">
        <div class="card-body">
          <div class="m-sm-4">
            <form id="subscribeForm" method="POST" onsubmit="return validate();">
